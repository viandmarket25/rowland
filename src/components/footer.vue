<template>
  ...
  .grid-container {
    display: grid;
    grid-template-rows: auto 1fr; /* Set the top section to auto height and the bottom section to fill the remaining space */
  ...
  .menu-overlay {
    position: fixed;
    top: 0;
    right: 0; /* Updated: Align the overlay to the right */
    width:100vw; /* Updated: Initially set the width to 0 */
    height: 100%;
    background-color: rgba(0, 0, 0, 0.5);
    display: flex;
    justify-content: flex-end; /* Updated: Align the menu content to the right */
    align-items: center;
    z-index: 9999;
    transition: width 0.3s; /* Added: Transition the width property */
  }
