  ...
  <div class="home-container">
    <div class="home-navbar">
      <header data-thq="thq-navbar" class="home-navbar-interactive">
        <div class="home-branding">
          <span class="home-text">Rowland</span>
        </div>
          ...
          <div data-thq="thq-mobile-menu-nav" data-role="Nav" class="home-nav1">
            <div class="home-top">
              <div class="home-branding1">
                <span class="home-text003">Rowland</span>
              </div>
    ...
    <div class="home-information">
      <div class="home-purpose">
        ...
        <span class="home-description">
          We are a leading machinery manufacturing company, producing high-quality industrial equipment with precision and reliability. Our advanced facilities and skilled workforce enable us to deliver innovative solutions that meet the diverse needs of our clients. From concept to delivery, customer satisfaction is our top priority, and we strive to exceed expectations through exceptional products and service.
        <br/><br/>
        作为领先的机械制造公司，我们以精确可靠的方式生产高质量的工业设备。凭借先进的设施和熟练的员工队伍，我们提供创新解决方案，满足客户的多样化需求。从概念到交付，客户满意是我们的首要任务，我们通过优质的产品和服务力争超越期望。
                </span>
      </div>
    ...
    <footer class="home-footer">
      <div class="home-header4">
        <span class="home-branding2">Rowland International (Yantai) co.,ltd</span>
      ...
      <div class="home-locations">
        ...
        <div class="home-location3">
          ...
          <span class="home-details10">
            <span>Whatsapp: +8617664096970</span>
            <br />
            <span>Rowland@vip.163.com</span>
            <br />
...
export default {
  ...
  methods: {
    showNextImage() {
      ...
      const index = this.images.findIndex(image => image.src === currentIndex);
      this.currentIndex = this.images[(index + 1) % this.images.length].src;
    }
  },
  metaInfo: {
    title: 'Rowland',
